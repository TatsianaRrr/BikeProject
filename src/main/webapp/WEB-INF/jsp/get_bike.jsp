            ...
            <c:choose>
               <c:when test="${userRole eq(admin)}">
                  ...
                  <form action="/bike/controller" method="post">
                     ...
                     Image:<input type="text" name="image" value="${bike.image}" /> <br />
                     Deleted:<input type="text" name="deleted" value="${bike.deleted}" /><br />
                     Ordered:<input type="text" name="ordered" value="${bike.ordered}" /><br />
                     <br />
